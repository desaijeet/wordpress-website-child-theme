...
<div class="container">
	...
	<?php
		...
		!empty($zerif_copyright)):
					...
					echo '<div>Created by: <a href="https://in.linkedin.com/pub/jeet-desai/48/781/717" target="_blank" rel="nofollow">Jeet Desai</a></div><br/>';
					
					echo '<div class="zerif-copyright">&copy; Geffta Enterprises Ltd.</div>';
					echo '</div>';
